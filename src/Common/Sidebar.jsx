...
export default function Sidebar({ open, onClose }) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex w-72 flex-col bg-slate-900 text-white transition-transform duration-300 lg:fixed     lg:left-0 lg:top-0 lg:h-screen lg:translate-x-0 ${
